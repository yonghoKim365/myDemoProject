...
PopupLogout::PopupLogout()
{
    ...
    //
    CCLabelTTF* remainLabel = CCLabelTTF::create("로그아웃 하시겠습니까?", "Thonburi", 13);
...
void PopupLogout::ccTouchesBegan(cocos2d::CCSet* touches, cocos2d::CCEvent* event){
    CCTouch *touch = (CCTouch*)(touches->anyObject());
    CCPoint location = touch->getLocationInView();
    location = CCDirector::sharedDirector()->convertToGL(location);
}

void PopupLogout::ccTouchesMoved(cocos2d::CCSet* touches, cocos2d::CCEvent* event)
{
    
}

void PopupLogout::ccTouchesEnded(cocos2d::CCSet* touches, cocos2d::CCEvent* event)
{
    CCTouch *touch = (CCTouch*)(touches->anyObject());
    CCPoint location = touch->getLocationInView();
    location = CCDirector::sharedDirector()->convertToGL(location);
    ...
    if(GetSpriteTouchCheckByTag(this, 701, localPoint))
    {
        ...
        MainScene::getInstance()->logoutKakao();
