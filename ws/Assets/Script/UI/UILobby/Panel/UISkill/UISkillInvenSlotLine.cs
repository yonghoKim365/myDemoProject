...
public class UISkillInvenSlotLine : UIListGridItemPanelBase 
{
	public UISkillInvenSlot slotPrefab;

	public int maxPerLine = 5;
	public float cellWidth = 100.0f;

	public UISkillInvenSlot[] slots = null;

	public GameIDData[] data;

	protected override void initAwake ()
	{
		slots = new UISkillInvenSlot[maxPerLine];
	...
	public override void setData (object obj)
	{
		...
		for(int i = 0; i < maxPerLine; ++i)
		{
			if(slots[i] == null)
			{
				slots[i] = Instantiate(slotPrefab) as UISkillInvenSlot;
