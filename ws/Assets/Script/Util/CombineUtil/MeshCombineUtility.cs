...
public class MeshCombineUtility {
	...
	public static Mesh Combine (MeshInstance[] combines, bool generateStrips, bool includeUV2 = true)
	{
		int vertexCount = 0;
		int triangleCount = 0;
		int stripCount = 0;
		...
		foreach( MeshInstance combine in combines )
		{
			if (combine.mesh) Copy(combine.mesh.vertexCount, combine.mesh.uv1, uv1, ref offset);
		}
