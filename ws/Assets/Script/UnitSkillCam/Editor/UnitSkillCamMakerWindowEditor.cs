...
[ExecuteInEditMode]
public class UnitSkillCamMakerWindowEditor : EditorWindow
{
	
	[MenuItem("WindSoul Editor/UnitSkillCam Window Editor")]
	static public void OpenEffectEditor ()
	{
		EditorWindow.GetWindow<UnitSkillCamMakerWindowEditor>(false, "Editor", true);
	}	

	static public UnitSkillCamMakerWindowEditor instance;
	...
	void OnGUI ()
	{
		...
		if(UnitSkillCamMaker.instance == null) return;
