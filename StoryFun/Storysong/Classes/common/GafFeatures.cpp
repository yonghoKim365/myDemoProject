...
void GafFeatures::setupMenuItems()
{
    ...
    items.pushBack(addButton("sample/buttons/previous_animation_button@2x.png", "sample/buttons/previous_animation_button_pressed@2x.png", cocos2d::Point(0.0f, Y),
    ...
    items.pushBack(addButton("sample/buttons/previous_frame_button@2x.png", "sample/buttons/previous_frame_button_pressed@2x.png", cocos2d::Point(0.1f, Y), std::bind(&GafFeatures::prevFrame, this, _1)));
    
    m_playButton = addButton("sample/buttons/play_button@2x.png", "sample/buttons/play_button_pressed@2x.png", cocos2d::Point(0.22f, Y),
                             [this](cocos2d::Ref* obj)
                             {
    ...
    m_pauseButton = addButton("sample/buttons/pause_button@2x.png", "sample/buttons/pause_button_pressed@2x.png", cocos2d::Point(0.22f, Y),
                              [this](cocos2d::Ref* obj)
                              {
                                  m_pauseButton->setVisible(false);
                                  m_playButton->setVisible(true);
    ...
    items.pushBack(addButton("sample/buttons/next_frame_button@2x.png", "sample/buttons/next_frame_button_pressed@2x.png", cocos2d::Point(0.34f, Y), std::bind(&GafFeatures::nextFrame, this, _1)));
    
    items.pushBack(addButton("sample/buttons/next_animation_button@2x.png", "sample/buttons/next_animation_button_pressed@2x.png", cocos2d::Point(0.44f, Y),
                             [this](cocos2d::Ref* obj)
                             {
                                 m_pauseButton->setVisible(true);
                                 m_playButton->setVisible(false);
    ...
    items.pushBack(addButton("sample/buttons/restart_button@2x.png", "sample/buttons/restart_button_pressed@2x.png", cocos2d::Point(0.57f, Y), std::bind(&GafFeatures::restart, this, _1)));
    
    items.pushBack(addButton("sample/buttons/white_bg_button@2x.png", "sample/buttons/white_bg_button_pressed@2x.png", cocos2d::Point(0.67f, Y),
                             [this](cocos2d::Ref* ob)
                             {
                                 static int mode = 0;
                                 mode ++;
    ...
    m_nextSequence = addButton("sample/buttons/right_arrow@2x.png", "sample/buttons/right_arrow_pressed@2x.png", cocos2d::Point(0.40f, 0.93f), std::bind(&GafFeatures::nextSequence, this, _1));
    
    m_prevSequence = addButton("sample/buttons/left_arrow@2x.png", "sample/buttons/left_arrow_pressed@2x.png", cocos2d::Point(0.05f, 0.93f), std::bind(&GafFeatures::prevSequence, this, _1));
    ...
    cocos2d::Sprite* gafLogo = cocos2d::Sprite::create("sample/buttons/gaf_logo@2x.png");
...
void GafFeatures::generateGafFilesList()
{
    ...
    m_files.push_back("sample/SoundsExample_Tank/SoundsExample_Tank.gaf");
    m_files.push_back("sample/cut_the_hope/cut_the_hope.gaf");
    m_files.push_back("sample/biggreen/biggreen.gaf");
    m_files.push_back("sample/bird_bezneba/bird_bezneba.gaf");
    m_files.push_back("sample/christmas2013_julia2/christmas2013_julia2.gaf");
    m_files.push_back("sample/fireman_2014_sound/fireman_2014_sound.gaf");
    m_files.push_back("sample/fairy2/fairy2.gaf");
    m_files.push_back("sample/firemen/firemen.gaf");
    m_files.push_back("sample/impiretank_05_oneplace/impiretank_05_oneplace.gaf");
    m_files.push_back("sample/myshopsgame4/myshopsgame4.gaf");
    m_files.push_back("sample/peacock_feb3_natasha/peacock_feb3_natasha.gaf");
    m_files.push_back("sample/tiger/tiger.gaf");
#endif // SEARCH_ALL_GAF_FILES
}
