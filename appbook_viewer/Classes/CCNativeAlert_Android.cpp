...
extern "C" {
	...
	JNIEXPORT void JNICALL Java_com_kid_Cocos2dxNativeAlert_alertDidDismiss(JNIEnv *env, jclass, jstring jid, jint jindex) {
...
void NativeAlert::showWithCallback( std::string title, std::string message, std::string cancelButtonTitle, std::string returnButtonTitle, std::string otherButtonTitle, int tag, const std::function<void( int tag, ButtonType type)> &callback )
{
	...
	if (! JniHelper::getStaticMethodInfo(t,KJAVA_CLASS, "showNativeAlert"  , "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"))
	{
		return ;
	}
